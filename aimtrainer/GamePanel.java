...
public class GamePanel extends JPanel implements Runnable, KeyListener {
    ...
    // ===== จำสถานะ attack frame ก่อนหน้า เพื่อจับจังหวะเริ่ม swing ใหม่ =====
    ...
    public GamePanel(Main main){
        ...
        new Timer(16, e -> {
            if (!stageClear) {
                ...
                if (targets.isEmpty() && player.getHealth() > 0) {
                    stageClear = true;
                    stageClareTimer = STAGE_CLEAR_DELAY;
                }
            } else {
    ...
    public void setMode(Mode mode){
        ...
        int targetSize;
        switch(mode){
            case EASY: targetSize = 100; break;
            case NORMAL: targetSize = 70; break;
            case HARD: targetSize = 50; break;
            default: targetSize = 80;
        }
    ...
    protected void paintComponent(Graphics g){
        ...
        if (stageClear) {
            ...
            boolean playerDead = player.getHealth() <= 0;
            g2.setColor(playerDead ? Color.RED : Color.YELLOW);
            g2.setFont(new Font("SansSerif", Font.BOLD, 80));
            FontMetrics fm = g2.getFontMetrics();
            String clearText = playerDead ? "GAME OVER" : "STAGE CLEARED!";
